...
class AccountMangas(object):
    ...
    def reload(self):
        ...
        assert 'user_reading' == xml_user_reading.tag, 'user_reading == {0:s}'.format(
            xml_user_reading.tag)
        ...
        assert 'user_plantoread' == xml_user_plantoread.tag, 'user_plantoread == {0:s}'.format(
